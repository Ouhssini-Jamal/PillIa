      ...
      <div class="upper-part">
       <div class="text-1">
          ...
          <h2>Synapse Plateforme, des 
           ...
           <br> démarche de conciliation médicamenteuse, faciliter l’aide à la
            
           <br> prescription, favoriser le lien ville hôpital, renforcer la 
            
           <br> pharmacovigilance et accompagner le grand public. Le tout
            
           <br> dans une seule et même plateforme.</p>
            <div class="commencer mt">
               <a class="btn-third" href="">Explore les solutions</a>
                 <div class="next-div"><a href=""><i class="fa-solid fa-arrow-right next-icon"></a></i>
                </div>
            </div>
        </div>
